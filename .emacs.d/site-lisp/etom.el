...
(defvar etom-tempfiles-to-delete nil
  "A list of temp files to delete")
...
(let (  
 ...
 (with-current-buffer etom-buffer  
   (let ((last-prompt (count-lines (point-min) (point-max))))  
     ...
     (add-to-list 'etom-tempfiles-to-delete tempfile)))))
...
(defun etom-delete-tempfiles ()
  (while etom-tempfiles-to-delete
    (delete-file (car etom-tempfiles-to-delete))
    (setq etom-tempfiles-to-delete (cdr etom-tempfiles-to-delete))))
